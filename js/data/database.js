/* 
  Of course, this is NOT a database; it's only standing in for one.
  The idea is to pull the data out of the website itself and stash it somewhere
  else, which is what would happen in a real-world app doing something like this
  one. 
*/
